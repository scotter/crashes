...
Historic traffic data is available from http://www.pasda.psu.edu/data/padot/state/historic/PaStateRoads/. After comparing this to the traffic data, they seem to have very similar coverage on traffic and roads. 
